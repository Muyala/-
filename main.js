...
mdui.confirm(''
        + '<div class="mdui-typo">'
        +     '<p>'
        +         '使用本工具<strong>不需要强制关注任何公众号或转发任何内容到朋友圈</strong>。如果你发现有存在类似<strong>“关注○○，发送○○，转发○○到朋友圈领取○○”</strong>的行为，请对此类<strong>诱导行为</strong>进行<strong>投诉</strong>。'
        ...
        +     '<p>欢迎使用本工具。<a href="" target="_blank">#对做抖音微信朋友圈段子有帮助！！！#</a></p>'
        + '</div>',
    '在开始使用之前……',
    function () {},
